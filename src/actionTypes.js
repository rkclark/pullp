export const home = {
  ...
  REQUEST_CURRENT_USER_LOADING: 'REQUEST_CURRENT_USER_LOADING',
  ...
  REQUEST_USER_TEAMS_SUCCESS: 'REQUEST_USER_TEAMS_SUCCESS',
  REQUEST_USER_TEAMS_FAIL: 'REQUEST_USER_TEAMS_FAIL',
};
...
export const setup = {
  ...
  REQUEST_GITHUB_TOKEN_LOADING: 'REQUEST_GITHUB_TOKEN_LOADING',
};
...
export const selectRepos = {
  ...
  RESET_SELECTED_REPOS: 'RESET_SELECTED_REPOS',
  ...
  LOADING_WATCHED_REPOS: 'LOADING_WATCHED_REPOS',
};
